...
import { createNodeWithSection, sortNodes, groupNodes, generateSortedText, normalizeNewlines } from "../utils/orderUtils.js"
...
export default {
  ...
  create(context) {
    ...
    validateSectionOrder(sectionOrder, DEFAULT_SECTION_ORDER);
